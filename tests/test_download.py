#!/usr/bin/env python3
"""
Test script for Cursor server download functionality
"""
...
def test_download():
    ...
    try:
        ...
        if server_file:
            print(f"✓ Server package downloaded successfully: {server_file}")
        ...
        if cli_file:
            print(f"✓ CLI package downloaded successfully: {cli_file}")
